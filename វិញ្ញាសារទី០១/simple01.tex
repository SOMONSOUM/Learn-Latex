...
\SetEnumitemKey{I}{%
leftmargin=*,
label={\protect\tikz[baseline=-0.9ex]\protect\node[draw=gray,thick,circle,minimum height=.65cm,inner sep=1pt,text=white,fill=magenta]{\Roman*};},%
...
\SetEnumitemKey{a}{%
leftmargin=*,%
label={\protect\tikz[baseline=-0.9ex]\protect\node[draw=gray,thick,circle,minimum height=.5cm,inner sep=1pt,text=white,fill=orange]{\alph*};},%
font=\small\sffamily\bfseries,%
labelsep=1ex,%
topsep=0pt}
%
